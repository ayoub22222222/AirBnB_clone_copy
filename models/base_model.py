...
class BaseModel:
    ...
    def __str__(self):
        ...
        comp_list = ['__module__', '__doc__', '__str__', 
                '__dict__', 'to_dict', '__weakref__', 'save']
        filter_dict = {key : value for key, value in copy_dict.items() if key not in comp_list}
        return "[{}] ({}) {}".format(
    ...
    def to_dict(self):
        ...
        new_one = {key : value for key, value in new_ob.items() if key not in comp_list}
